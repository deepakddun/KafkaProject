...
class Station(Producer):
    ...
    # accoring to https://knowledge.udacity.com/questions/293650 this should be arrival_value.json so this needs to be corrected.
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"{station_name}_{station_id}" # TODO: Come up with a better topic name
        print(f"##### STATION TOPIC NAME ###### {topic_name}")
        super().__init__(
            topic_name,
